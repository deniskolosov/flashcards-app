...
def upgrade() -> None:
    ...
    op.add_column('reviews', sa.Column('interval_days', sa.Integer(), nullable=False, server_default='1'))
    op.add_column('reviews', sa.Column('repetitions', sa.Integer(), nullable=False, server_default='0'))
